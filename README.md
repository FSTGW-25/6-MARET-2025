...
<body>
  <div class="title-box">11 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>


  <div class="music-box">
    <h2>IMPERFECT LOVE</h2>
    <p>SEVENTEEN</p>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 18.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Imperfect Love.mp3');
    ...
    const fullMessage = `"Hari ini adalah hadiah, jalani dengan penuh syukur. 🌻 Lakukan yang terbaik dalam setiap hal yang kamu lakukan." 🌼`;
